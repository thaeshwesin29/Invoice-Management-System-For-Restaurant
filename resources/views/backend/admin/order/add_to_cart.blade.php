...
@section('js')
    ...
    <script>
        ...
        createApp({
            ...
            methods: {
                // pagination --- start
                fetchProducts(url = '/admin/order/get-product-list/data') {
                    axios.get(url)
                        .then(response => {
                ...
                fetchProductsPage(page) {
                    const url = `/admin/order/get-product-list/data?page=${page}&category_id=${this.category_id}`;
                ...
                filterCategory(category_id) {
                    ...
                    const url = `/admin/order/get-product-list/data?category_id=${this.category_id}`;
                    this.fetchProducts(url);
                },
                // Category filter --- end
                ...
                // Add to cart --- start
                getAddToCartOrder() {
                    axios.get('/admin/order/get-add-to-cart-order/data')
                        .then(response => {
                ...
                addToCart(product_id, status) {
                    axios.post('/admin/order/add-to-cart-order-items', {
                        product_id,
                        status
                    })
                        .then(response => {
                            ...
                            axios.post(`/admin/order/${order_id}/confirm`)
                                .then(response => {
                                    ...
                                    if (res.success) {
                                        ...
                                        setTimeout(() => {
                                            window.location.href = `/admin/order/${order_id}`;
                                        }, 2000);
                                    } else {
                            ...
                            axios.post(`/admin/order/${order_id}/cancel`)
                                .then(response => {
                                    ...
                                    if (res.success) {
                                        ...
                                        setTimeout(() => {
                                            window.location.href = `/admin/order/add-to-cart/form`;
                                        }, 2000);
                                    } else {
                                        toastr.warning(res.message);
                                    }
